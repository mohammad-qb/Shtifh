    ...
    for (const element of orders) {
      ...
      await this.prismaService.notification.create({
        data: {
          ...
          type: 'REMINDER',
          content_ar: setNotificationText(
            element.order.employee?.user.lang || 'AR',
            'order-em',
            {
              date: element.order.date.toDateString(),
              time: element.order.time,
          ...
          content_en: setNotificationText(
            element.order.employee?.user.lang || 'EN',
            'order-em',
            {
              date: element.order.date.toDateString(),
          ...
          content_he: setNotificationText(
            element.order.employee?.user.lang || 'HE',
            'order-em',
            {
              date: element.order.date.toDateString(),
              time: element.order.time,
      ...
      await this.prismaService.notification.create({
        data: {
          ...
          type: 'REMINDER',
          content_ar: setNotificationText(
            element.order.customer?.user.lang || 'AR',
            'order-cu',
            {
              date: element.order.date.toDateString(),
              time: element.order.time,
          ...
          content_he: setNotificationText(
            element.order.customer?.user.lang || 'HE',
            'order-cu',
            {
              date: element.order.date.toDateString(),
              time: element.order.time,
